...
public class Read {
	...
	public static char checkAddOverFlow(char carry, String resstr, String register1, String register2) {
		char overFlow = '0';
		if (resstr.length() > 6) {
			overFlow = Character.forDigit(Character.getNumericValue(carry) ^ Character.getNumericValue(resstr.charAt(1)) ^ Character.getNumericValue(register1.charAt(0)) ^ Character.getNumericValue(register2.charAt(0)), 10);
		} else {
			overFlow = Character.forDigit(Character.getNumericValue(carry) ^ Character.getNumericValue(resstr.charAt(1)) ^ Character.getNumericValue(register1.charAt(0)) ^ Character.getNumericValue(register2.charAt(0)), 10);
		}
		return overFlow;
	...
	static Queue<String> leftToDecode = new LinkedList<String>();

	public static void run() {
		int clockCycles = 1;
		int maxCylces = 6; // Gets number of cycles
